...
describe("estree.extractLogicalExpression", () => {
  it("should extract two Nodes from a LogicalExpression with two operands", () => {
  ...
  it("should extract all nodes and add up all Literal values", () => {
  ...
  it("should extract all Nodes but with different operators and a LogicalExpr on the right", () => {

...
describe("isArrayExpression probe", () => {
  it("should trigger analyzeLiteral method one time", (t) => {
    const str = "['foo']";
  ...
  it("should trigger analyzeLiteral method two times (ignoring the holey between)", (t) => {
    const str = "[5, ,10]";
  ...
  it("should trigger analyzeLiteral one time (ignoring non-literal Node)", (t) => {
    const str = "[5, () => void 0]";

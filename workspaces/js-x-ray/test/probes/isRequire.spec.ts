...
describe("isRequire probe", () => {
  it("should ignore require CallExpression with no (zero) arguments", () => {
    const str = `
      require()
    `;
  ...
  it("should execute probe using process.mainModule.require (detected by the VariableTracer)", () => {
    const str = `
  ...
  it("should execute probe using process.getBuiltinModule (detected by the VariableTracer)", () => {
    const str = `
  ...
  it("should execute probe on a variable reassignments of require (detected by the VariableTracer)", () => {
    const str = `
      const r = require;
      const b = r;
      b("http");
  ...
  it("should catch require with an Identifier argument pointing to the Node.js core http module", () => {
    const str = `
      const foo = "http";
      require(foo);
    `;
  ...
  it("should throw an 'unsafe-import' warning for a require with an unknown Identifier", () => {
    const str = `
      require(foo);
    `;
    const ast = parseScript(str);
  ...
  it("should throw an 'unsafe-import' warning for a require with an unknown MemberExpression", () => {
    const str = `
      require(foo.bar);
    `;
    const ast = parseScript(str);
  ...
  it("should catch require with a Literal argument having for value the Node.js core http module", () => {
    const str = `
      require("http");
    `;
    const ast = parseScript(str);
  ...
  it(`should catch require with an ArrayExpression where all Literals values concatened
  ...
  it(`should throw an 'unsafe-import' warning for using an ArrayExpression as require argument
  ...
  it(`should catch require with a BinaryExpression where all level of operands flattened
  are equal to the Node.js core http module`, () => {
    const str = `
      require("ht" + "tp");
    `;
  ...
  it(`should throw an 'unsafe-import' warning for using a BinaryExpression
  ...
  it(`(require CallExpression): should catch a CallExpression containing an hexadecimal value
  ...
  it("(require CallExpression): should detect MemberExpression Buffer.from", () => {
    const str = `
  ...
  it("(require CallExpression): should detect MemberExpression require.resolve with a Literal value", () => {
    const str = `
  ...
  it("(require CallExpression): should detect obfuscated atob value", () => {
    const str = `
      const myFunc = atob;
  ...
  it("(require CallExpression): should not have an unsafe-import for a correct path.resolve", () => {
    const str = `

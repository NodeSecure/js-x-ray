...
describe("isLiteral probe", () => {
  it("should throw an unsafe-import because the hexadecimal string is equal to the core 'http' dependency", (t) => {
    ...
    const analyzeStringMock = t.mock.method(
      sastAnalysis.sourceFile.deobfuscator,
      "analyzeString"
    );
  ...
  it("should throw an encoded-literal warning because the hexadecimal value is equal to 'require'", (t) => {
  ...
  it("should not throw an encoded-literal warning because hexadecimal value is safe", () => {
  ...
  it("should throw an encoded-literal warning because hexadecimal value is not safe", () => {
  ...
  it("should not throw any warnings without hexadecimal value (and should call analyzeLiteral of Analysis class)", (t) => {
    ...
    const sastAnalysis = getSastAnalysis(isLiteral);
    const analyzeLiteralMock = t.mock.method(
      sastAnalysis.sourceFile,
      "analyzeLiteral"
    );
    sastAnalysis.execute(ast.body);
  ...
  describe("known suspicious domain", () => {
    ...
    it("should detect shady link when an URL is known to be suspicious when protocol is http", () => {
    ...
    it("should detect shady link when an URL is known to be suspicious when protocol is https", () => {
      for (const suspicousDomain of suspiciousDomains) {
  ...
  it("should detect shady link when an URL has a suspicious domain", () => {
  ...
  it("should mark suspicious links the IPv4 address range 127.0.0.0/8 (localhost 127.0.0.1)", () => {
  ...
  it("should be considered suspicious a link with a raw IPv4 address 127.0.0.1 and a port", () => {
  ...
  it("should detect the link as suspicious when a URL contains a raw IPv4 address", () => {
  ...
  it("should detect suspicious links when a URL contains a raw IPv4 address with port", () => {
  ...
  it("should detect suspicious links when a URL contains a raw IPv6 address", () => {
  ...
  it("should detect suspicious links when a URL contains a raw IPv6 address with port", () => {
  ...
  it("should collect public ip address", () => {
  ...
  it("should collect and detect private address with an Information severity", () => {
  ...
  it("should not collect a hostname when there is none", () => {
  ...
  it("should not detect file:// link ", () => {
  ...
  describe("email collection", () => {
    it("should collect valid email addresses", () => {
      const str = `
    ...
    it("should not collect invalid email formats", () => {
      const str = `
    ...
    it("should collect emails from various code contexts", () => {
      const str = `
    ...
    it("should track email locations correctly", () => {
      ...
      assert.deepStrictEqual(locationInfo.metadata, {});

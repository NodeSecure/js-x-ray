...
describe("isRegexObject probe", () => {
  it("should not throw a warning because the given Literal RegExp is considered 'safe'", () => {
  ...
  it("should throw a 'unsafe-regex' warning because the given RegExp Object is unsafe", () => {

...
describe("isImportDeclaration probe", () => {
  it("should detect 1 dependency for an ImportNamespaceSpecifier", () => {
  ...
  it("should detect 1 dependency for an ImportDefaultSpecifier", () => {
  ...
  it("should detect 1 dependency for an ImportSpecifier", () => {
  ...
  it("should detect 1 dependency with no specificiers", () => {
  ...
  it("should detect 1 dependency for an ImportExpression", () => {
    const str = "import(\"bar\")";
    const ast = parseScript(str);
    const sastAnalysis = getSastAnalysis(isImportDeclaration)
      .execute(ast.body);
  ...
  it("should detect an unsafe import using file: and throw a unsafe-import warning", () => {

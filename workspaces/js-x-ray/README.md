...
- `crypto.weak-pbkdf2` - Detects weak PBKDF2 parameters (low iteration count, short or hardcoded salt)
...
| [crypto.weak-pbkdf2](https://github.com/NodeSecure/js-x-ray/blob/master/docs/crypto.weak-pbkdf2.md) ⚠️ | **Yes** | Usage of weak PBKDF2 parameters (low iteration count, short or hardcoded salt) |

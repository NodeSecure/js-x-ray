const sast_warnings = {
  ...
  crypto_api_misuse: "تم اكتشاف استخدام غير آمن محتمل لواجهة برمجة التطبيقات crypto في Node.js. يشمل ذلك عدد تكرارات PBKDF2 غير كافٍ (الحد الأدنى الموصى به 100,000) أو ملح ضعيف/مفقود لدوال اشتقاق المفاتيح."
};

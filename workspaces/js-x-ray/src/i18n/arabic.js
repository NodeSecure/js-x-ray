export const sast_warnings = {
  ...
  weak_pbkdf2: "استخدام crypto.pbkdf2() أو crypto.pbkdf2Sync() بمعاملات غير آمنة: عدد تكرارات أقل من الحد الأدنى الموصى به من OWASP ‏(600,000 لـ SHA-256 و210,000 لـ SHA-512)‏، أو ملح مضمّن في الشيفرة أو قصير (أقل من 16 بايت). هذه الإعدادات الضعيفة تُضعف أمان اشتقاق المفاتيح من كلمات المرور.",
};

export const sast_warnings = {
  ...
  weak_pbkdf2: "안전하지 않은 매개변수로 crypto.pbkdf2() 또는 crypto.pbkdf2Sync()가 사용되었습니다: OWASP 권장 최소값(SHA-256의 경우 600,000회, SHA-512의 경우 210,000회) 미만의 반복 횟수, 또는 하드코딩되거나 짧은 salt(16바이트 미만). 이러한 취약한 설정은 비밀번호 기반 키 유도의 보안을 손상시킵니다.",
};
